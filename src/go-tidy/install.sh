...
if [ "${INSTALL_GO_TOOLS}" = "true" ]; then
    ...
    # Note: golangci-lint installation has been removed in this tidy version
    # to avoid checksum verification issues that may occur with the golangci-lint installer
